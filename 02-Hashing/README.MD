...
* [2248. Intersection of Multiple Arrays](./Counting/EX_intersectionMultipleArrays.py) — *Uses counts to find elements present in all N arrays.*
* [1941. Equal Number of Occurrences](./Counting/EX_areOccurrencesEqual.py) — *Uses `counts.values()` and `set()` to verify frequencies.*
* [560. Subarray Sum Equals K](./Counting/EX_subarraySumK.py) — *The standard Prefix Sum + Hashing implementation.*
* [1248. Count Number of Nice Subarrays](./Counting/EX_countNumOfNiceSubarrays.py) — *Transforms odds/evens into 1s/0s to use the same logic.*
...
* [Destination City](./destinationCity.py)
* [Path Crossing](./isPathCrossing.py)
* [Count Elements Max Frequency](./countElementsMaxFrequency.py)
* [Find Lucky](./findLucky.py)
* [Unique Number of Occurrences](./uniqueOccurrences.py)
* [Sort Characters By Frequency](./frequencySort.py) - https://leetcode.com/problems/sort-characters-by-frequency/description/
    - good problem to review
* [Length of Longest Subarray With at Most K Frequency](./maxSubarrayLength.py) - https://leetcode.com/problems/length-of-longest-subarray-with-at-most-k-frequency/description/
    - good problem to review (i was able to do it pretty easily but still good to look back on)

* [Number of Good Pairs](./numOfGoodPairs.py) - https://leetcode.com/problems/number-of-good-pairs/description/
    - good problem to review, question why we do the two pass, see if we can do the one pass

* [Binary Subarrays with Sum](./binarySubArraysSum.py) - https://leetcode.com/problems/binary-subarrays-with-sum/description/
    - REALLY STRUGGLED WITH THIS, need to review this 
    - also review the solutions 
        - one using prefix sum
        - the other using sliding window

* [Maximum Erasure Value](./maxErasureValue.py) - https://leetcode.com/problems/maximum-erasure-value/description/
    - good problem to review

* [Permutation in String](./permutationInString.py) - https://leetcode.com/problems/permutation-in-string/description/
    - RLLY GOOD PROBLEM TO REVIEW
    - had some trouble, needed some hints from gemini
    - extra notes in the file but try to solve it again on my own

* [Isomorphic Strings](./isIsomorphic.py) - https://leetcode.com/problems/isomorphic-strings/description
    - good problem to review as well despite the "easy" level

* [Word Pattern](./wordPattern.py) - https://https://leetcode.com/problems/word-pattern/description/
    - basically another "Isomorphic Strings" Problem

* [Custom Sort String](./customSortString.py) - https://leetcode.com/problems/custom-sort-string/description/
    - good problem to review, needed a little help from gemini

* [Close Strings](./closeStrings.py) - https://leetcode.com/problems/determine-if-two-strings-are-close/description/
    - GREAT PROBLEM TO REVIEW, was able to solve it but needed a tiny push from gemini for the best time complexity
