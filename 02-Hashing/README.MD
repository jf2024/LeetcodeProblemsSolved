...
# add these to the notes somewhere (ask gemini)
Anytime you find your algorithm running if ... in ..., then consider using a hash map or set to store elements to have these operations run in O(1)O(1).